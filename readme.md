...
- `Buffer_over_Flow/` - exploitation labs that demonstrate memory corruption.  
- `MD5_PDF_Collision/` - practical MD5 collision artifacts and scripts for studying data integrity attacks.  
